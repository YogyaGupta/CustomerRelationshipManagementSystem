def addcustomer():
    ...
    addroot.iconbitmap('customer.ico')
...
def searchcustomer():
    def search():
        ...
        if(id != ''):
            ...
            strr = 'select *from customerdata1 where dob=%s'
    ...
    searchroot.iconbitmap('customer.ico')
...
def updatecustomer():
    def update():
        ...
        strr = 'update customerdata1 set name=%s,mobile=%s,email=%s,address=%s,gender=%s,dob=%s,date=%s,time=%s where id=%s'
    ...
    updateroot.iconbitmap('customer.ico')
...
def Connectdb():
    def submitdb():
        ...
        try:
            ...
            mycursor.execute(strr)
            strr = 'create table customerdata1(id int,name varchar(20),mobile varchar(12),email varchar(30),address varchar(100),gender varchar(50),dob varchar(50),date varchar(50),time varchar(50))'
            mycursor.execute(strr)
    ...
    dbroot.iconbitmap('customer.ico')
